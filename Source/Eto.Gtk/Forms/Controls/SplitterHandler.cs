...
namespace Eto.GtkSharp.Forms.Controls
{
	public class SplitterHandler : GtkContainer<Gtk.Paned, Splitter, Splitter.ICallback>, Splitter.IHandler
	{
		...
		/// of each panel.  This may follow standard behaviour in GTK, but is not compatible behaviour with other platforms.
		/// 
		...
		/// <code>
		/// Eto.Style.Add<Eto.GtkSharp.Forms.Controls.SplitterHandler>(h => h.RestrictToContentSize = true);
		/// </code>
		/// </summary>
		/// <value><c>true</c> if restrict to content size; otherwise, <c>false</c>.</value>
